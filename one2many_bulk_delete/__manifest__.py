{
    ...
    'images': [
        ...
        'static/description/screenshot_1_selection.png',
        'static/description/screenshot_2_select_all.png',
        'static/description/screenshot_3_confirmation.png',
        'static/description/screenshot_4_success.png',
    ],
    'installable': True,
    'application': False,
    'auto_install': False,
